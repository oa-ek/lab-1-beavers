        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGameOwnerships", x => x.OwnershipId);
                    table.ForeignKey(
                        name: "FK_UserGameOwnerships_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGameOwnerships_GameId",
                table: "UserGameOwnerships",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGameOwnerships_UserId",
                table: "UserGameOwnerships",
                column: "UserId");
